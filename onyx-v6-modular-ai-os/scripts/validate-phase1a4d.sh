...
for value in AWAITING_DRAFT_PR_APPROVAL APPROVED_FOR_DRAFT_PR_CREATION DRAFT_PR_CREATION_IN_PROGRESS DRAFT_PR_CREATED DRAFT_PR_CREATION_FAILED_SAFE DRAFT_PR_RECONCILIATION_REQUIRED CREATE_DRAFT_PR coolscorpiorahul test831495/onyx-alpha1-transfer 'Issue 7' 'Phase 1A.4A Live Smoke Test' feature/phase1a4a-github-issue-bridge feature/phase1a4d-draft-pr-bridge baseCommit headCommit; do grep -Fq "$value" "$src"; done
