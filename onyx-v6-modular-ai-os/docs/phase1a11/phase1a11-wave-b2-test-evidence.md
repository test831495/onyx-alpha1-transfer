...
The focused B2 suite contains 10 deterministic tests covering creation, evaluation, boundary expiry, malformed time, versions, rotation, revocation, switching, step-up, shared devices, audit, and presentation. Wave A regression is exactly 10 tests; Wave B1 regression is exactly 14 tests.
