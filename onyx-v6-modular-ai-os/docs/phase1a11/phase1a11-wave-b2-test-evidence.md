...
The focused B2 suite contains 26 deterministic tests covering creation, evaluation, terminal step-up denial, boundary expiry, shared chronology validation, malformed timing, versions, role binding, referential permission binding, rotation, explicit revocation scopes and evidence, switching, step-up bindings and audit, shared devices, strict concurrency references, presentation, assurance ranking, deterministic projection IDs, and operation-specific chronology reasons. Wave A regression is exactly 10 tests; Wave B1 regression is exactly 14 tests.
