...
function resolveSemanticPurpose(normalized: string, hasSessionContext: boolean): ConversationalPurposeResolution | null {
  ...
  if (/(?:oh my god|wow|this seems broken|it seems you are fully broken|this is broken|im frustrated|i am frustrated|this is frustrating|damn|sucks|this is bad|seriously|i had a good day|i had a great day|i had a bad day|it was a good day|it was a great day)/i.test(short)) return Object.freeze({ purpose: "GENERAL_CONVERSATION", clarificationRequired: false, activeTopicUsed: hasSessionContext });
