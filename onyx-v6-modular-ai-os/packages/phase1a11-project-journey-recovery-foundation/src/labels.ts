...
export interface FriendlyLabel {
  ...
  technicalInformation: { available: boolean; defaultVisible: false; notes: string };
  createsAuthority: false;
}

const label = (title: string, explanation: string, safeNextAction: string, severity: FriendlyLabel["severity"] = "INFO"): FriendlyLabel => ({
  title,
  explanation,
  safeNextAction,
  severity,
...
export const OPERATING_MODE_LABELS: Record<OperatingMode, FriendlyLabel> = {
...
export const CONTINUITY_EVIDENCE_LABELS: Record<EvidenceState, FriendlyLabel> = { AUTHORITATIVE: FRIENDLY_LABELS.AUTHORITATIVE, INCOMPLETE: FRIENDLY_LABELS.INCOMPLETE, CONFLICTING: FRIENDLY_LABELS.CONFLICTING, UNVERIFIED: FRIENDLY_LABELS.UNVERIFIED };
export const CONTINUITY_GAP_LABELS: Record<ContinuityGapType, FriendlyLabel> = { MISSING_EVIDENCE: FRIENDLY_LABELS.MISSING_EVIDENCE, CONFLICTING_EVIDENCE: FRIENDLY_LABELS.CONFLICTING_EVIDENCE, UNVERIFIED_SOURCE: FRIENDLY_LABELS.UNVERIFIED_SOURCE, UNRECORDED_INTERVAL: FRIENDLY_LABELS.UNRECORDED_INTERVAL };
export const JOURNEY_EVENT_LABELS: Record<JourneyEventKind, FriendlyLabel> = { MILESTONE: FRIENDLY_LABELS.MILESTONE, ROADMAP_DECISION: FRIENDLY_LABELS.ROADMAP_DECISION, ARCHITECTURE_DECISION: FRIENDLY_LABELS.ARCHITECTURE_DECISION, ACCEPTANCE_CHANGE: FRIENDLY_LABELS.ACCEPTANCE_CHANGE, IMPLEMENTATION_OUTCOME: FRIENDLY_LABELS.IMPLEMENTATION_OUTCOME, POLICY_EXERCISE: FRIENDLY_LABELS.POLICY_EXERCISE, RECOVERY_EXERCISE: FRIENDLY_LABELS.RECOVERY_EXERCISE };
export const SUMMARY_QUALITY_LABELS: Record<SummaryQuality, FriendlyLabel> = { COMPLETE: FRIENDLY_LABELS.COMPLETE, COMPRESSED: FRIENDLY_LABELS.COMPRESSED, PARTIAL: FRIENDLY_LABELS.PARTIAL, NOT_RECORDED: FRIENDLY_LABELS.NOT_RECORDED };
export const RECOVERY_PACKAGE_LABELS: Record<RecoveryPackageState, FriendlyLabel> = { DESCRIBED: FRIENDLY_LABELS.DESCRIBED, ELIGIBLE_PENDING: FRIENDLY_LABELS.ELIGIBLE_PENDING, READY_PENDING: FRIENDLY_LABELS.READY_PENDING, INVALID: FRIENDLY_LABELS.INVALID, NOT_IMPLEMENTED: FRIENDLY_LABELS.NOT_IMPLEMENTED };
export const INTEGRITY_LABELS: Record<IntegrityState, FriendlyLabel> = { EXPECTED: FRIENDLY_LABELS.EXPECTED, UNVERIFIED: FRIENDLY_LABELS.NOT_VERIFIED, CORRUPT: FRIENDLY_LABELS.CORRUPT, MALFORMED: FRIENDLY_LABELS.MALFORMED, NOT_IMPLEMENTED: FRIENDLY_LABELS.NOT_IMPLEMENTED };
export const COPY_HEALTH_LABELS: Record<CopyHealthState, FriendlyLabel> = { AVAILABLE_PROJECTION: FRIENDLY_LABELS.AVAILABLE_PROJECTION, UNAVAILABLE: FRIENDLY_LABELS.UNAVAILABLE, STALE: FRIENDLY_LABELS.STALE, CONFLICTING: FRIENDLY_LABELS.CONFLICTING, NOT_VERIFIED: FRIENDLY_LABELS.NOT_VERIFIED };
export const ARCHIVE_HEALTH_LABELS: Record<ArchiveSetHealth, FriendlyLabel> = { HEALTHY_PROJECTION: FRIENDLY_LABELS.HEALTHY_PROJECTION, DEGRADED: FRIENDLY_LABELS.DEGRADED, CRITICAL: FRIENDLY_LABELS.CRITICAL, UNVERIFIED: FRIENDLY_LABELS.NOT_VERIFIED };
export const RECOVERY_ROUTE_LABELS: Record<RecoveryRouteClass, FriendlyLabel> = { LOCAL: FRIENDLY_LABELS.LOCAL, OFFLINE: FRIENDLY_LABELS.OFFLINE, REMOTE_SUPPLEMENT: FRIENDLY_LABELS.REMOTE_SUPPLEMENT };
export const STORAGE_PRESSURE_LABELS: Record<StoragePressureState, FriendlyLabel> = { NORMAL: FRIENDLY_LABELS.NORMAL, ELEVATED: FRIENDLY_LABELS.ELEVATED, CRITICAL: FRIENDLY_LABELS.CRITICAL, UNVERIFIED: FRIENDLY_LABELS.NOT_VERIFIED };
export const RETENTION_LABELS: Record<RetentionDecision, FriendlyLabel> = { RETAIN: FRIENDLY_LABELS.RETAIN, RETAIN_PENDING_REVIEW: FRIENDLY_LABELS.RETAIN_PENDING_REVIEW, DEFER: FRIENDLY_LABELS.DEFER, DENY_DESTRUCTIVE_ACTION: FRIENDLY_LABELS.DENY_DESTRUCTIVE_ACTION };
export const SANITIZATION_LABELS: Record<SanitizationDecision, FriendlyLabel> = { ALLOWED_METADATA_ONLY: FRIENDLY_LABELS.ALLOWED_METADATA_ONLY, DENIED_PRIVATE_DATA: FRIENDLY_LABELS.DENIED_PRIVATE_DATA, DENIED_CREDENTIALS: FRIENDLY_LABELS.DENIED_CREDENTIALS, DENIED_UNKNOWN: FRIENDLY_LABELS.DENIED_UNKNOWN };
export const ACCEPTANCE_FAMILY_LABELS: Record<AcceptanceFamily, FriendlyLabel> = { JOURNEY: FRIENDLY_LABELS.MILESTONE, RECOVERY: FRIENDLY_LABELS.DESCRIBED, INTEGRITY: FRIENDLY_LABELS.EXPECTED, ARCHIVE: FRIENDLY_LABELS.HEALTHY_PROJECTION };