export const PRESENTATION_LABELS = {
  ...
  ACCOUNT_SUSPENDED: "Account temporarily unavailable",
  AUTHENTICATION_ASSURANCE_REQUIRED: "Please verify your identity to continue",
  POLICY_DENY: "You do not have permission to view this information",
  DETAILED_PROJECT_HISTORY: "Detailed Project History",
  BASIC_PROJECT_INFORMATION: "Project Overview"
} as const;
