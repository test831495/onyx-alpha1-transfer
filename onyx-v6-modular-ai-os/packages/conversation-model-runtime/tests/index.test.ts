...
const request = { requestId: "r", sessionId: "s", turnId: "t", utteranceGeneration: 1, language: "ENGLISH", selectedSpeaker: "NOVA", characterProfileVersion: "B5B-1", conversationPurpose: "REFLECTION", responseMode: "CONVERSATION", responseObjectives: ["acknowledge"], recentTurnSummaries: [], currentTopic: null, supportedClaims: [], prohibitedClaims: ["execution"], truthStatus: "GROUNDED", sourceReferences: [], uncertaintyPolicy: "NONE", responseLengthPolicy: "BRIEF", followUpPolicy: "OPTIONAL", operatingMode: "TEXT", privacyClass: "STANDARD", trustedCapabilityFacts: [], requestVersion: "B5F-1" } as const satisfies ConversationModelRequest;
