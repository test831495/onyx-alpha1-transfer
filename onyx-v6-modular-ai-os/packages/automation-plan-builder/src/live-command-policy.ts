...
const allowed=[["gh","auth","status"],["gh","issue","view"],["gh","api"],["git","remote","get-url"],["git","rev-parse"],["git","branch","--list"],["git","switch","-c"],["git","push","-u","origin"],["gh","pr","list"],["gh","pr","create","--draft"]];
