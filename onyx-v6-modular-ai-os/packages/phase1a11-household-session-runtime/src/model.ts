...
export interface SessionRecord { sessionId: SessionId; familyId: SessionFamilyId; revision: SessionRevision; binding: SessionBinding; authenticationAssurance: AuthenticationAssurance; versions: SessionVersionBinding; timing: SessionTiming; revocationTime?: string; revocationActorAccountId?: AccountId; revocationReason?: SessionReason; revocationPurpose?: string; revocationFamilyWide?: boolean; replacementReference?: SessionId; status: SessionStatus; stepUp?: StepUpGrant; sharedDevice: DeviceClassification; audit: SessionAuditRequirement; provenanceReference: string; }
...
export interface ConcurrentSessionReference { accountId: AccountId; sessionId: SessionId; }
