...
function composeText(plan: ResponsePlan, speaker: "ONYX" | "NOVA"): string {
  ...
  if (plan.purpose === "GENERAL_CONVERSATION") return speaker === "ONYX" ? "I can help with that. What would you like to talk about?" : "I can help with that. What would you like to explore?";
