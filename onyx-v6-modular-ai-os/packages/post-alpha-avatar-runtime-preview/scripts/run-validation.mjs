...
async function validate() {
  ...
  try {
    ...
    await verifySidecar("fixture-manifest.json");
    await verifySidecar("asset-provenance.json");
    await verifySidecar("acceptance-coverage.json");
    ...
    console.log(`Package B validation passed: ${passed}/${testCount} tests, ${testFiles} files, typecheck passed`);
  } finally {
