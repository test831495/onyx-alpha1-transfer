...
export const APP_REGISTRY: AppRegistryEntry[] = [
  ...
  },
  {
    ...
    component: <WorkspacePanel snapshot={{ providers: [], activeProvider: undefined, updatedAt: Date.now() } as any} busy={false} onConnect={() => undefined} onReconnect={() => undefined} onDisconnect={() => undefined} onRefresh={() => undefined} />,
    detailComponent: <WorkspacePanel snapshot={{ providers: [], activeProvider: undefined, updatedAt: Date.now() } as any} busy={false} onConnect={() => undefined} onReconnect={() => undefined} onDisconnect={() => undefined} onRefresh={() => undefined} />,
    launcherOrder: 4,
    icon: "▣",
    supportsMinimize: true,
    supportsClose: true,
  ...
  },
  {
    ...
    supportsClose: true,
    supportsDetails: true,
    compactSummary: "Calendar Intelligence is ready.",
  },
  {
    appId: "automation",
