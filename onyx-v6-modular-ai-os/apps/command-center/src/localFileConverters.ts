...
export const LOCAL_FILE_CONVERTER_REGISTRY: readonly LocalFileConverterRegistration[] = [
...
export function convertersFor(mimeType: string): readonly LocalFileConverterRegistration[] { return LOCAL_FILE_CONVERTER_REGISTRY.filter((converter) => converter.available && converter.sourceMimeTypes.includes(mimeType)); }