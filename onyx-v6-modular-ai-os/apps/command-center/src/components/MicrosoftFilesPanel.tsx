...
export function MicrosoftFilesPanel({
  ...
  return <section className="microsoft-files-panel" aria-labelledby="microsoft-files-heading" style={{ borderTop: "1px solid color-mix(in srgb, currentColor 18%, transparent)", paddingTop: "0.8rem", display: "grid", gap: "0.8rem" }}>
