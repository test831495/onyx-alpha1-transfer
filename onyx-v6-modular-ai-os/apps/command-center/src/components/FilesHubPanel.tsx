...
function LocalFileWorkspace({ onNavigationChange, onFullScreenChange }: { readonly onNavigationChange?: (canGoBack: boolean, onBack: () => void) => void; readonly onFullScreenChange?: (fullScreen: boolean) => void }) {
